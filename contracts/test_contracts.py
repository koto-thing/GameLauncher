...
class ContractTests(unittest.TestCase):
    ...
    def test_reviewed_sources_match_runtime_contracts(self) -> None:
        ...
        source_contracts = {
            self.root / "contracts/examples/game-release.source.json":
                "game-release-source.schema.json",
            self.root / "backend/content/announcements/ja-JP.json":
                "announcements-source.schema.json",
            self.root / "backend/content/announcements/en-US.json":
                "announcements-source.schema.json",
            self.root / "backend/content/launcher/release.ja-JP.json":
                "launcher-release-source.schema.json",
            self.root / "backend/content/launcher/release.en-US.json":
                "launcher-release-source.schema.json",
            self.root / "backend/content/launcher/changelog.ja-JP.json":
                "launcher-changelog.schema.json",
            self.root / "backend/content/launcher/changelog.en-US.json":
                "launcher-changelog.schema.json",
        }
    ...
    def test_public_urls_allow_http_only_for_exact_local_hosts(self) -> None:
        ...
        schema = json.loads(
            (self.root / "contracts" / "schemas" / "game-release.schema.json")

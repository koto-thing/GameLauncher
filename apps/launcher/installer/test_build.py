...
from apps.launcher.installer.build import configure_metadata
from apps.launcher.installer.e2e import installed_launcher, maintenance_tool, platform_executable
...
class InstallerBuildTests(unittest.TestCase):
    ...
    def test_installer_visual_configuration_and_bundled_assets(self) -> None:
        ...
        self.assertTrue((root.parents[2] / "assets/images/PandDLogo.png").is_file())
    ...
    def test_windows_package_contains_dedicated_uninstaller(self) -> None:
        ...
        source = root / "apps/launcher/src/uninstaller/UninstallerMain.cpp"

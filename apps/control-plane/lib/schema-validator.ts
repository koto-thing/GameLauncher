...
import descriptorSchema from "../../../contracts/schemas/deployment-artifact-descriptor.schema.json" with { type: "json" };
import gameReleaseSourceSchema from "../../../contracts/schemas/game-release-source.schema.json" with { type: "json" };

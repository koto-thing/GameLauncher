...
void LauncherWindow::applyTheme() {
    ...
    setStyleSheet(
        QString("QMainWindow,QWidget#page,QDialog{background:%1;color:%3;}"
                ...
                "QPushButton#account,QPushButton#account:hover{background:transparent;border:0;padding:0;}"
                ...
                "QPushButton#nav:checked,QPushButton#libraryNav:checked{background:transparent;color:%3;"
